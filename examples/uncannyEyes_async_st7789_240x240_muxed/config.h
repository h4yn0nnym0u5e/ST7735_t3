...
// DISPLAY HARDWARE SETTINGS (screen type & connections) -------------------
  ...
  #define SPI_FREQ 48'000'000    // TFT: use max SPI (clips to 12 MHz on M0)
...
muxedEyeInfo_t eyeInfo[] = {
   {[](bool negate){ CSfn(2,negate); }, 10, -1, -1, 1, 0}
  ,{[](bool negate){ CSfn(1,negate); }, 10, -1, -1, 1, 0}
};
